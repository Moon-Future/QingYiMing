...
const qrcodeProduct = require('./api/qrcodeProduct')
const deliveryQrcode = require('./api/deliveryQrcode')
...
router.use('/qrcodeProduct', qrcodeProduct.routes())
router.use('/deliveryQrcode', deliveryQrcode.routes())
